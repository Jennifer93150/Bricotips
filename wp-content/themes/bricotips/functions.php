...
function theme_enqueue_styles(){
    ...
    // Chargement du /css/widgets/lien-image-widget.css pour notre widget lien image
    wp_enqueue_style('lien-image-widget', get_stylesheet_directory_uri() . '/css/widgets/lien-image-wigdet.css', array(), filemtime(get_stylesheet_directory() . '/css/widgets/lien-image-wigdet.css'));
...
require_once(__DIR__ . '/widgets/LienImageWidget.php');
...
function register_widgets()
{
    ...
    //On enregistre le widget avec la class Lien_Image_Widget
    register_widget('Lien_Image_Widget');
}
...
{//in_the_loop() permet de n'avoir le resultat que sur le contenu de la page et pas ailleurs
...
function loop_end_action()
{
    if (is_archive()):
        ...
        <p class="after-loop">
            <?php
                echo do_shortcode('[banniere-titre src="http://localhost:8888/bricotips/wp-content/uploads/2023/03/banniere-image.webp" titre="BricoTips"]');
            ?>
        </p>
        <?php
   endif;
