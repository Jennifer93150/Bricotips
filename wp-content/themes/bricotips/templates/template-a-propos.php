...
<main id="apropos">
    ...
    <?php
    // je rappelle le shortcode de la banniere utilisé sur la pg accueil
        echo do_shortcode('[banniere-titre titre="À propos de BricoTips" src="http://localhost:8888/bricotips/wp-content/uploads/2023/03/banniere-image.webp"]');
    ?>
