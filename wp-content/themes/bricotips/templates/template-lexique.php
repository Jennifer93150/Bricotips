...
<main id="lexique">
    ...
    <?php
        // Je parcours le tab du dessus et a chq tour j'appelle la fonction get_template_part() qui me permet d'appeler le fichier bloc-lexique où est codé la partie html avec le mot + sa def à afficher
        foreach($definitions as $definition){
            // en param le chemin du fichier, nom du modele spec = null(pas besoin), la variable $definition = array qui contient un mot et sa def
